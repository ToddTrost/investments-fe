...
const API_URL = 'https://ttrost.pythonanywhere.com'; /* 'http://localhost:8000' http://127.0.0.1:8000/ or  'http://yourPythonAnywhereName.pythonanywhere.com/'*/
  ...
  export class APIService {
    ...
    //Added CRUD capabilities for stock calls
    getStock(param_pk) {
